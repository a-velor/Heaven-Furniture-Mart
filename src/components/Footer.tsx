...
export const Footer: React.FC<FooterProps> = ({ onOpenQuote }) => {
  ...
  return (
    <footer className="bg-[#0B1719] dark:bg-[#050B0C] text-[#FAF8F5] pt-16 pb-12 border-t border-[#C5A880]/25 relative transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-[11px] text-stone-500 gap-4">
          <div>
            © {new Date().getFullYear()} Heaven Furniture Mart. Founded in 2020 by Abul Kalam Bhuiyan. All rights reserved.
          </div>
