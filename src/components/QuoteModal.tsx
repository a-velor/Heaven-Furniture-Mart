...
import { X, CheckCircle2, MessageCircle, Send, Sparkles, Phone, ShieldCheck } from 'lucide-react';
import { WOOD_SPECIES } from '../data/furnitureData';
...
export const QuoteModal: React.FC<QuoteModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const generatedRef = 'HFM-' + Math.floor(100000 + Math.random() * 900000);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {submitted ? (
          <div className="p-8 sm:p-10 text-center space-y-6 my-auto">
