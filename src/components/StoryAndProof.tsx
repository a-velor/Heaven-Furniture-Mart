...
import { Quote, Award, CheckCircle, Star, Calendar, Building2 } from 'lucide-react';
import { MILESTONES, TESTIMONIALS } from '../data/furnitureData';

export const StoryAndProof: React.FC = () => {
  return (
    <section id="story" className="py-20 lg:py-28 bg-[#FAF8F5] dark:bg-[#0B1617] text-[#2C221E] dark:text-[#F2EFE9] relative border-t border-stone-200 dark:border-stone-800 transition-colors duration-300">
