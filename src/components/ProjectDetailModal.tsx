...
import { X, MapPin, Calendar, Clock, Check, ArrowRight, MessageCircle, Sparkles, Ruler, ShieldCheck, Layers } from 'lucide-react';
        ...
        <div className="overflow-y-auto p-6 sm:p-8 space-y-8">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              {project.craftsmanshipHighlights.map((highlight, index) => (
                <div
                  key={index}
          ...
          {project.testimonialSnippet && (
            <div className="p-4 bg-white dark:bg-[#152528] border-l-2 border-[#C5A880] text-xs text-stone-700 dark:text-stone-300 italic">
