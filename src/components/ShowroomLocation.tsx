...
import { MapPin, Phone, Mail, Clock, MessageCircle, ArrowRight, ShieldCheck, Check } from 'lucide-react';

interface ShowroomLocationProps {
  onOpenQuote: () => void;
}

export const ShowroomLocation: React.FC<ShowroomLocationProps> = ({ onOpenQuote }) => {
  return (
    <section id="showroom" className="py-20 lg:py-28 bg-[#132629] dark:bg-[#081213] text-[#FAF8F5] relative overflow-hidden transition-colors duration-300">
