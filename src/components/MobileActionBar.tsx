...
/**
 * MobileActionBar: Docked luxury mobile bottom action bar for high-touch ergonomics.
 * Provides instant 1-tap access to phone consultation, WhatsApp artisan chat,
 * and custom bespoke quote requests with safe-area support.
 */
